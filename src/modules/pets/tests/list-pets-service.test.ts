...
describe('List Pets Service', () => {
  ...
  it('should return a list of pets for the user (customer)', async () => {
    const pets = [
      { id: '1', userId: 'user-id', name: 'Buddy', species: 'Dog', breed: 'Golden', age: 4, weight: 30 },
      { id: '2', userId: 'user-id', name: 'Mittens', species: 'Cat', breed: 'Siamese', age: 2, weight: 5 }
    ]
  ...
  it('should return all pets for admin', async () => {
    const pets = [
      { id: '1', userId: 'user-1', name: 'Buddy', species: 'Dog', breed: 'Golden', age: 4, weight: 30 },
      { id: '3', userId: 'user-2', name: 'Rex', species: 'Dog', breed: 'Labrador', age: 5, weight: 35 }
    ]
